from backend.ai.agent_gemini_api import add_crucial_ingredients, get_agent_response, normalize_ingredients
...
if __name__ == '__main__':
    ...
    while True:
        ...
        ingredients = json.loads(normalize_ingredients(gemini, sys_norm_prompt, user_norm_prompt))["ingredients"]
        print(ingredients)
